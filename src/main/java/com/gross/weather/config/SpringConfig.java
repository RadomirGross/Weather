    ...
    public class SpringConfig implements WebMvcConfigurer {
        ...
        public SpringLiquibase liquibase(DataSource dataSource) {
            ...
            liquibase.setDefaultSchema("weather"); // Указываем схему, если нужно
            liquibase.setShouldRun(true); // Можно выключить, если не хочешь запускать Liquibase при старте
            return liquibase;
        }
       /* @Bean
        public LocalSessionFactoryBean sessionFactory() {
            ...
            sessionFactory.setPackagesToScan("com.gross.weather.model");
